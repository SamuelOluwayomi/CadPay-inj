...
export default function SignIn() {
    ...
    const { signInWithPassword, signInWithBiometric, signInWithGoogle, checkEmailExists, clearError, isLoading, error } = useAuth();
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <button 
                            ...
                            disabled={isLoading}
                            className="group relative w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white text-black font-bold rounded-xl transition-all hover:bg-zinc-200 active:scale-[0.98] disabled:opacity-50"
                        >
                            ...
                            <div className="absolute inset-0 rounded-xl bg-orange-500/0 group-hover:bg-orange-500/5 transition-colors" />
                        </button>
                    </div>
